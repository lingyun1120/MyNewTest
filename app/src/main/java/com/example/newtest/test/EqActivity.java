...
public class EqActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMediaPlayer = MediaPlayer.create(this, R.raw.innocence);
        ...
        Button btLimiter = findViewById(R.id.btLimiter);
        btLimiter.setOnClickListener(v -> {
            mDynamicsProcessingLimiter = new DynamicsProcessing.Limiter(
                    true,
                    LIMITER_DEFAULT_ENABLED,
                    LIMITER_DEFAULT_LINK_GROUP,
                    Float.parseFloat(((EditText) findViewById(R.id.etAttack)).getText().toString()),
                    Float.parseFloat(((EditText) findViewById(R.id.etRelease)).getText().toString()),
                    Float.parseFloat(((EditText) findViewById(R.id.etRatio)).getText().toString()),
                    Float.parseFloat(((EditText) findViewById(R.id.etThreshold)).getText().toString()),
                    Float.parseFloat(((EditText) findViewById(R.id.etGain)).getText().toString())
            );
